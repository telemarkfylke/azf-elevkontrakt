...
const validateStudentInfo = async (ssn, onlyAnsvarlig) => {
  ...
  const dataToReturn = {
    ...
    gotSchoolName: schoolInfoData.navn !== null, // True/false
    gotSchoolEpost: schoolInfoData.kontaktEpostadresse !== null, // True/false
    gotSchoolTelefon: schoolInfoData.kontaktTelefonnummer !== null, // True/false
    gotSchoolAdresse: schoolInfoData.postadresse?.adresselinje !== null, // True/false
    gotSchoolOrgNr: schoolInfoData.organisasjonsnummer !== null, // True/false
    student: {
